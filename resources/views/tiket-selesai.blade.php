...
<body>
    ...
    <div class="content p-4">
        <div class="container">
            <h2 class="p-4" style="text-align: center;">Tiket Pelayanan<center><hr></center></h2>
            ...
            <div class="col-md-2"></div>
            <div class="col-md-12 d-flex justify-content-center p-4"><button type="submit" class="btn btn-primary rounded-pill" href="#">Lacak Tiket</button></div>
            </div>
            <h3 class="text-center p-4">No. Tiket <a class="text-primary">TX7621</a></h3>
            <div class="row">
                <div class="col-md-5 text-end">
                    <h4>Status</h4>
                </div>
                <div class="col-md-7">
                    <p>Dalam Proses <span>08.00 WIB</span></p>
                    <p>Proses Akademik <span>09.00 WIB</span></p>
                    <p>Selesai <span>13.00 WIB</span></p>
                </div>
            </div>
            <div class="col-md-12 d-flex justify-content-center p-4"><button type="submit" class="btn btn-primary rounded-pill">Diterima</button></div>
        </div>
    </div>

    <div class="container mx-auto">
        <div class="h3 text-center">Rating</div>
        <div class="p text-center">Berikan penilaian terhadap Unit Pelayanan Terpadu Poliwangi</div>
        <div class="row d-flex justify-content-center mt-4 mb-4">
            <img src="{{asset('svg/Unstar.svg')}}" alt="Unstar"style="width: 10vh;">
            <img src="{{asset('svg/Unstar.svg')}}" alt="Unstar"style="width: 10vh;">
            <img src="{{asset('svg/Unstar.svg')}}" alt="Unstar"style="width: 10vh;">
            <img src="{{asset('svg/Unstar.svg')}}" alt="Unstar"style="width: 10vh;">
            <img src="{{asset('svg/Unstar.svg')}}" alt="Unstar"style="width: 10vh;">
        </div>
        <div class="h3 text-center">Saran</div>
        <div class="col-md-2"></div>
        <div class="col-md-12 justify-content-center">
            <div class="form-floating">
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
            <label for="floatingTextarea2">Tulisakan Saran Anda Terhadap Pelayanan </label>
        </div>
        </div>
        <div class="col-md-2"></div>
